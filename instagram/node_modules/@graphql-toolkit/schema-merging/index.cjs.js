...
function mergeSchemas({ schemas, typeDefs, resolvers, resolversComposition, schemaDirectives, resolverValidationOptions, logger, ...config }) {
    return graphqlTools.makeExecutableSchema({
        typeDefs: mergeTypeDefs([...schemas, ...(typeDefs ? common.asArray(typeDefs) : [])], config),
        resolvers: common.composeResolvers(mergeResolvers([...schemas.map(schema => common.extractResolversFromSchema(schema)), ...(resolvers ? common.asArray(resolvers) : [])], config), resolversComposition || {}),
        schemaDirectives,
