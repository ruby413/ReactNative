import { parse, buildASTSchema, GraphQLScalarType, GraphQLObjectType, GraphQLInterfaceType, GraphQLEnumType, GraphQLUnionType, getDirectiveValues, Kind, defaultFieldResolver, GraphQLBoolean, GraphQLInt, GraphQLString, GraphQLFloat, GraphQLID, printSchema, print, printType, specifiedRules, validate, buildClientSchema, Source } from 'graphql';
...
function fixSchemaAst(schema, options) {
    if (!schema.astNode || !schema.extensionASTNodes) {
        const schemaWithValidAst = buildASTSchema(parse(printSchemaWithDirectives(schema), {
            noLocation: true,
            ...(options || {}),
        }), {
